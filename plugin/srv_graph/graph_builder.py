...
class GraphBuilder(object):
	...
	def build(self, service_graph):
		...
		dic_elem = {}
		dic_elem[serv_graph._node_instance['id']] = serv_graph
		relationships = []
		...
		for instance in service_graph._contained_instances:
			...
			if wrap_comp_type in instance._node.type_hierarchy:
			...
			elif runt_comp_type in instance._node.type_hierarchy:
		...
		for relationship in relationships:
			...
			if conto_rel_type in rel_obj._relationship.type_hierarchy:
